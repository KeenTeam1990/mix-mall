<template>
	<view class="container">
		...
		<view class="mp-search-box">
			<input class="ser-input" type="text" placeholder="输入" value="输入关键字搜索" disabled />
		</view>
		<!-- #endif -->
		...
		<view class="carousel-section">
			...
			<swiper class="carousel" circular interval="500" duration="500" @change="swiperChange">
		...
		<view class="seckill-section m-t">
			<view class="s-header">
				<image class="s-img" src="/static/temp/secskill-img.jpg" mode="widthFix" @load="timeadd"></image>
				<text class="tip">8点场</text>
				<text class="hour timer">07</text>
				<text class="minute timer">13</text>
				<text class="second timer">{{countAddNum}}</text>
				...
				<swiper-item class="g-swiper-item" v-for="(item, index) in goodsList" :key="index"
					...
					<view class="g-item right">
						...
						<view class="t-box">
							...
							<view class="pro-box">
							  	<view class="progress-box">
							  		<progress percent="92" activeColor="#fa436a" active stroke-width="6" />
							  	</view>
								<text>10人成团</text>
							</view>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			timeadd(){
				let that = this;
				that.intervaild = setInterval(()=>{
					if (that.countAddNum == 60) {
						that.countAddNum = 0;
					}
					that.countAddNum ++;	
				},1000);
